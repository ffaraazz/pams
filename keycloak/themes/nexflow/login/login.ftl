...
<div id="kc-container" class="kc-login-container">
  ...
  <div class="nf-card">
    ...
    <form id="kc-form-login" action="${url.loginAction}" method="post">
      ...
      <div class="nf-form-group">
        <label class="nf-label" for="password">${msg("password")}</label>
        <div class="nf-input-wrap">
        ...
        <div class="nf-row">
          <#if realm.rememberMe?? && realm.rememberMe>
            <label class="nf-check-group">
              ...
              <span class="nf-check-label">${msg("rememberMe")}</span>
            </label>
          <#else><span></span></#if>
          <#if realm.resetPasswordAllowed>
            <a class="nf-link" href="${url.loginResetCredentialsUrl}">${msg("doForgotPassword")}</a>
          </#if>
        </div>
      </#if>
